...
cat1.makeSound();
console.log("############ TV #############");
const TV1 = new Tv_1.Tv;
TV1.turnOff();
TV1.turnOn();
console.log("############ Radio #############");
const Radio1 = new Radio_1.Radio;
Radio1.turnOff();
Radio1.turnOn();
console.log("############ CreditCardPayment #############");
const Card1 = new CreditCardPayment_1.CreditCardPayment("31245", 5000);
Card1.pay("31245", 100);
console.log("############ Motorcycle #############");
const Motor1 = new Motorcycle_1.Motorcycle("Honda");
Motor1.startEngin();
Motor1.fly();
Motor1.stopEngin();
console.log("############ Car #############");
const Car1 = new Car_1.Car("Honda");
Car1.chargeBattery();
Car1.startEngin();
Car1.stopEngin();
